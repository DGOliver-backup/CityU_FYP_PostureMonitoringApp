package com.example.o1mlkit4.classifiers.ExercisePlugIn.FRSQ
...
class FrontSquadClassifier : BaseClassifier {

    override val name: String = "Front Squad (Free Weights)"
    override val code: String = "FRSQ"
    override val type:String = "legs"
    ...
    override fun classify(image: com.google.mlkit.vision.common.InputImage, pose: Pose): ClassificationResult {
        ...
        // Update the flags and count based on the average angle
    ...
    private fun updateFlagsAndCount(averageAngle: Double): Boolean {
        ...
        if (initialized) {
            if (!down && averageAngle <90 ) {

                down = true
                up = false
            } else if (down && averageAngle >165.0) {

                up = true // Mark the "up" state as true
            }
