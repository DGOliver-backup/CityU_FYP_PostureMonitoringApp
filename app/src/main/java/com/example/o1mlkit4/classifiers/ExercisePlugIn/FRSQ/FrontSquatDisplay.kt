    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = Modifier) {
                ...
                if (rightAngle > 0) {
                    val rightAngleTemp =rightAngle
                    Text(
                        text = "Average Knee Angle (counting): ${rightAngleTemp.roundToInt()}°",
                        fontSize = 20.sp,
                ...
                if (averageAngle > 0) {
                    Text(
                        text = "Average Armpit Angle (monitoring): ${averageAngle.roundToInt()}° (${if (averageIsValid) "OK" else "Out"})",
                        fontSize = 20.sp,
                        fontWeight = FontWeight.Bold,
