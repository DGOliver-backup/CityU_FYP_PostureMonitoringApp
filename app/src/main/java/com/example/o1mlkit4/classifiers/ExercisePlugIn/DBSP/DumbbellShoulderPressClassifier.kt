package com.example.o1mlkit4.classifiers.ExercisePlugIn.DBSP
...
class DumbbellShoulderPressClassifier : BaseClassifier {

    override val name: String = "Dumbbell Shoulder Press (Free Weights)"
    override val code: String = "DBSP"
    override val type:String = "shoulder"
    ...
    private fun updateFlagsAndCount(averageAngle: Double): Boolean {
        ...
        if (initialized) {
            if (!up && averageAngle > 165) {
                down = false
                up = true
            } else if (up && averageAngle < 105) {
                down = true
            }
