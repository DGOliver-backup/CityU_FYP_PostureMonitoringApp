    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = Modifier) {
                ...
                if (rightAngle > 0) {
                    Text(
                        text = "Average Armpit Angle (monitoring): ${rightAngle.roundToInt()}° (${if (rightIsValid) "OK" else "Out"})",
                        fontSize = 20.sp,
                        fontWeight = FontWeight.Bold,
                ...
                if (averageAngle > 0) {
                    Text(
                        text = "Average Elbow Angle (monitoring): ${averageAngle.roundToInt()}° (${if (leftIsValid) "OK" else "Out"})",
                        fontSize = 20.sp,
                        fontWeight = FontWeight.Bold,
