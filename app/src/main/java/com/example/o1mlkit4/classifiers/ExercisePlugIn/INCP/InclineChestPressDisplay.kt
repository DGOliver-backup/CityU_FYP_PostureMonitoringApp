    ...
    Box(
        ...
        Column(
            ...
            Column(modifier = Modifier) {
                if (leftAngle > 0) {
                    Text(
                        text = "Average Elbow (counting): ${averageAngle.roundToInt()}°",
                        fontSize = 20.sp,
                ...
                if (averageAngle > 0) {
                    Text(
                        text = "Average Elbow (monitoring): ${averageAngle.roundToInt()}° (${if (averageIsValid) "OK" else "Out"})",
                        fontSize = 20.sp,
                        fontWeight = FontWeight.Bold,
